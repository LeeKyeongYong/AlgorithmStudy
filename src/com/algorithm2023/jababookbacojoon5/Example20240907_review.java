...
public class Example20240907_review { //2017 카카오코드 예선 신비로운 유적 탐험 복습


    /*
      탬플릿 메소드 패턴을 사용하여 MCMF 알고리즘의 각 단계를 분리
     */
    ...
    static abstract class AbstractGraph {
        ...
        AbstractGraph(int size, int src, int sink) {
            this.src = src;
            this.sink = sink;
    ...
    static class Graph extends AbstractGraph {
